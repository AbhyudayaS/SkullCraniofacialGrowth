...
public class DrawLines : MonoBehaviour {
	...
	void DrawConnectingLines() 
	{
		...
		{
			if(mainPoint.GetComponent<Renderer>().sharedMaterial.color == overOut.startcolor || mainPoint.GetComponent<Renderer>().sharedMaterial.color == overOut.rolOvrColor || mainPoint.GetComponent<Renderer>().sharedMaterial.color == overOut.msDownColor)
			{
